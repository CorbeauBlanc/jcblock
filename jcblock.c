...
// The program will then have all the basic capabilities except the
// star key (*-key) feature.
// Note: (on 21 July, 2018), DO_TONES activates software detection
// of a *-key keypad entry. It has never been too reliable. If you
// want the *-key feature (highly recommended). I suggest you get a
